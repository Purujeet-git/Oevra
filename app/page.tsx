...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* SECTION 2 */}
      <div className="relative z-20 h-screen flex flex-col text-mauve-500 items-center justify-center bg-black/50 backdrop-blur-md">
      ...
      <div ref={thirdSectionRef} className="relative z-20 h-screen overflow-hidden bg-black/80">
